    ...
    if(priceCtx) {
        new Chart(priceCtx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Harga Minggu Ini (Rp)', // Diubah
                    ...
                    {
                        label: 'Harga Minggu Lalu (Rp)', // Diubah
